# This script creates region clusters of C14 sites using an extended k-means algorithm.
# It optimizes the total number of clusters based on SPD growth rates and saves the results.
# The script processes data in parallel mode if specified and generates plots for visual analysis.
...
# Output files:
# - out/plots/cluster_withinss<ti>_<cscrit>.png
# - out/plots/clusters_<cc[1]><tis>.png
# - out/bin/clusti_<cc[1]><tis>_<cscrit>.bin
# - out/mat/clusti_<tis>_<cscrit>.mat

# Variables:
# - scdir: Directory for output files
# - myargs: Command line arguments for time segments and clustering parameters
# - ti0, ti1: Start and end time segments
# - cscrit: Critical cluster size
# - cc: Region name
# - XOUT: Flag for output to window
# - base: Basemap for plotting
# - nclustsum: Sum of clusters
# - bcs: Cluster parameter
# - itern: Number of iterations for k-means
# - lons, lats: Longitude and latitude of sites
# - nn: Number of sites
# - kmax: Maximum number of clusters
# - clusti: Cluster indices
# - wi: Within-cluster sum of squares
# - mcs: Minimum cluster size
# - mincsv: Minimum cluster size vector
# - wss0: Within-cluster sum of squares for single cluster
# - cluster: K-means clustering result
# - wss: Within-cluster sum of squares
# - k0: Index of minimum within-cluster sum of squares
# - mf: Skill function for minimal cluster size
# - ww: Weighted within-cluster sum of squares
# - Xa: Cluster summary string
# - xrange, yrange: Ranges for plotting
# - cmap: Color map for plotting
# - cluc: Cluster assignments
# - mincs0: Minimum cluster size for optimal clustering
# - cluster0: Optimal clustering result
# - rgrm: Mean growth rate for clusters
# - pcl: Cluster indices for plotting
